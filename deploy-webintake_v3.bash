...
usage() {
  ...
  echo " - First argument: Webintake installation path"
...
# Check Server UP
if ! pgrep -f "bin/apache/latest/conf" > /dev/null; then
    echo -e "\n Error: WEBINTAKE must be started before running this script. \n"
    exit 1
fi
...
declare KIT_URL="${KIT_URL}/${WEBINTAKE_VERSION}/webintake-installation-${WEBINTAKE_VERSION}.tar"
